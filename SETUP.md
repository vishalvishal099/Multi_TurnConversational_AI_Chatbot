...
- "What are the specs of the Pro Laptop?"
- "How much does the SmartWatch cost?"

### Order & Shipping
- "What is the status of order TM-2024-001234?"
...
### Multi-Turn (Test in sequence)
1. "Tell me about the Pro Laptop"
...
2. Review the error logs in `/tmp/backend.log`
